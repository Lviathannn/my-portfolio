...
export const portfolioData = [
   {
      ...
      Image: "demo3.png",
      caption:
         "This is my web portfolio which I created using React JS, Tailwind CSS,Vite JS, and using several other libraries such as Swiper JS and ScrollReveal JS",
      link: "home",
   ...
   },
   {
      ...
      Image: "demo4.png",
      caption:
         "On this website you can catch pokemon randomly, this website is made using HTML, Tailwind CSS, Javascript and Pokemon API",
