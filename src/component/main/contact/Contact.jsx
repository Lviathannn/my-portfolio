            ...
            <div className=" contact__info flex flex-col justify-center items-center p-10 py-10 rounded-xl shadow-md w-11/12 sm:w-2/3 lg:w-2/6 lg:px-0 lg:py-10 overflow-hidden dark:bg-slate-700 bg-white">
               <div className="flex flex-col gap-5 justify-center">
                  <div className="flex gap-4">
                     <Telephone className="md:text-4xl text-2xl text-indigo-500"></Telephone>
                  ...
                  <div className="flex gap-4">
                     <Envelope className="md:text-4xl text-2xl text-indigo-500"></Envelope>
                     <div className="flex flex-col">
                        <h1 className="md:text-lg font-medium text-slate-600 dark:text-slate-50">
                           Email
                        </h1>
                  ...
                  <div className="flex gap-4">
                     <GeoAlt className="md:text-4xl text-2xl text-indigo-500"></GeoAlt>
                     <div className="flex flex-col">
                        <h1 className="md:text-lg font-medium text-slate-600 dark:text-slate-50">
                           Location
                        </h1>
            ...
            >
               <div className="w-full">
                  ...
                  <input
                     ...
                     name="name"
                     placeholder="Name"
                     className="mt-2 block w-full px-2 py-1 rounded-md focus:ring-2 focus:ring-indigo-500 focus:outline-none text-sm md:text-base bg-slate-100 dark:bg-slate-500"
                     required
                  />
               </div>
               <div className="w-full">
               ...
               <div className="w-full">
                  ...
                  <textarea
                     ...
                     name="message"
                     rows="4"
                     className="bg-slate-100 dark:bg-slate-500 mt-2 block w-full px-2 py-1 rounded-md focus:ring-2 focus:ring-indigo-500 focus:outline-none text-sm md:text-base resize-none"
               ...
               <button
                  type="submit"
                  className="px-3 py-1 bg-indigo-500 text-slate-50 rounded-md self-start mt-5 flex justify-center items-center gap-1"
               >
